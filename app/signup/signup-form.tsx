    ...
    return (
      <div className="rise rounded-2xl border border-rule bg-surface p-6">
        ...
        <p className="mt-2 text-sm leading-relaxed text-mute">
          ...
          Open it on this device to activate your account and set up your
          profile. If it does not arrive in a minute, check spam.
        </p>
      </div>
    );
  }
  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <p className="pt-1 text-xs leading-relaxed text-mute">
        No password — we confirm your email with a sign-in link. Klimr is
