              ...
              <div key={a.id} className="rounded-2xl border border-rule bg-surface p-5">
                ...
                <form action={reviewProviderApplication} className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  <input
                    ...
                    className="min-w-[180px] flex-1 rounded-xl border border-rule bg-bg px-3 py-1.5 text-sm text-ink outline-none focus:border-brand"
                  />
        ...
        <form action={setClassProvider} className="mt-4 grid gap-3 sm:grid-cols-[1fr_1fr_auto] sm:items-end">
          <label className="block">
            ...
            <input
              ...
              required
              placeholder="uuid"
              className="w-full rounded-xl border border-rule bg-bg px-3 py-2 text-sm text-ink outline-none focus:border-brand"
            />
          </label>
          <label className="block">
