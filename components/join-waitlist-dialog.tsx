                ...
                <div className="grid gap-3">
                  ...
                  <div className="rounded-2xl border border-rule p-3.5">
                    ...
                    <input
                      ...
                      className="mb-2 w-full rounded-xl border border-rule bg-bg px-3.5 py-2.5 text-sm text-ink outline-none placeholder:text-faint focus:border-brand"
                    />
                    <div className="flex gap-2">
                      <input
                        ...
                        className="min-w-0 flex-1 rounded-xl border border-rule bg-bg px-3.5 py-2.5 text-sm text-ink outline-none placeholder:text-faint focus:border-brand"
                      />
                      <button
                        type="button"
                        onClick={doEmail}
