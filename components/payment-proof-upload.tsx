  ...
  return (
    <div>
      ...
      <div className="mt-2.5 flex items-center gap-3">
        <button type="button" onClick={upload} disabled={!file || busy} className="press inline-flex items-center gap-1.5 rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#B52D0B]-deep disabled:opacity-50">
