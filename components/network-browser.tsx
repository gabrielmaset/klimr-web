...
function EmptyState({ tab }: { tab: Tab }) {
  ...
  return (
    <div className="rounded-3xl border border-dashed border-rule bg-surface/50 p-12 text-center">
      ...
      <Link href="/players" className="press mt-4 inline-flex items-center gap-1.5 rounded-lg bg-brand px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#B52D0B]-deep">
