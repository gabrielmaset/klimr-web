      ...
      {confirming ? (
        <div className="mt-3 rounded-xl border border-brand/40 bg-tint-brand/60 p-3.5">
          ...
          <div className="mt-3 flex items-center gap-3">
            <button type="button" onClick={gen} disabled={busy === "gen"} className="press inline-flex items-center gap-1.5 rounded-lg bg-brand px-3 py-2 text-xs font-semibold text-white hover:bg-[#B52D0B]-deep disabled:opacity-50">
