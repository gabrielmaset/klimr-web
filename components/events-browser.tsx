    ...
    <div>
      ...
      <div className="relative mb-3">
        ...
        <input
          ...
          className="w-full rounded-2xl border border-rule bg-surface shadow-e1 py-3 pl-10 pr-4 text-sm text-ink outline-none placeholder:text-faint focus:border-brand"
        />
      </div>
