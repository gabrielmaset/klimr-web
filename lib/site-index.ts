...
export const SITE_INDEX: SiteEntry[] = [
  ...
  { title: "Health & Nutrition", href: "/health", keywords: ["health", "nutrition", "nutritionist", "dietitian", "dietitians", "wellness", "injury", "recovery", "massage", "massage therapist", "physical therapist", "physio", "athletic trainer", "mental performance"], description: "Health and nutrition resources and verified providers.", section: "discover" },
