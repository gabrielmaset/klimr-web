    ...
    <div className="rounded-3xl border border-rule bg-surface shadow-e1 p-5 sm:p-6">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        <button
          ...
          onClick={build}
          disabled={busy}
          className="press inline-flex items-center gap-2 rounded-lg bg-brand px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#B52D0B]-deep disabled:opacity-50"
        >
