      ...
      {!live ? (
        <div className="flex flex-1 flex-col items-start justify-center py-2">
          <form action={toggleFormAction} className="contents">
            ...
            <button
              ...
              className="press inline-flex items-center gap-2 rounded-lg bg-brand px-6 py-3 text-base font-bold text-white transition hover:bg-[#B52D0B]-deep disabled:opacity-60"
            >
        ...
        <div className="mt-4 flex flex-1 flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link href={`/queue/${session!.id}`} className="press inline-flex items-center gap-1.5 rounded-lg border border-white/20 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/10">
