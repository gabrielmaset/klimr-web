...
import { Bell, CalendarClock, Trophy, Swords, ShoppingBag, Sparkles, Megaphone, UserPlus, UserCheck } from "lucide-react";
...
export default async function NotificationsPage() {
  ...
  // Visiting IS reading: clear the badge everywhere (this render still styles
  // what was new). The live badge picks the UPDATE up in real time.
  if (unread > 0) {
